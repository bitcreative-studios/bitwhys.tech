...
const Lorem = () => (
  <>
    ...
    <p>
      ...
      Nullam accumsan lorem in dui. <em>Cras ultricies mi</em> eu turpis
      hendrerit fringilla. Vestibulum ante ipsum primis in faucibus orci luctus
      et ultrices posuere cubilia Curae; In ac dui quis mi consectetuer lacinia.
    ...
    <p>
      ...
      turpis. <strong>Pellentesque posuere.</strong> Praesent turpis. Aenean
      posuere, tortor sed cursus feugiat, nunc augue blandit nunc, eu
      sollicitudin urna dolor sagittis lacus.
    </p>
    <h2>Proactively envisioned multimedia</h2>
    <p>
    ...
    <p>
      ...
      lacus. Donec elit libero, sodales nec, volutpat augue.
    </p>
    <h3>
      This is an <strong>important</strong> sub list!
    </h3>
    <ol>
      <li>Furori adacto</li>
